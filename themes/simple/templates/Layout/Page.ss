...
<div class="content-container unit size3of4 lastUnit">
    ...
    <p>
        To analyse your own projects, please use our <a href="https://github.com/sunnysideup/silverstripe-dataintegritytests/blob/master/code/CheckForMysqlPaginationIssuesBuildTask.php">test</a>.
        You can try out this test <a href="dev/tasks/CheckForMysqlPaginationIssuesBuildTask">right here</a>
    </p>
    <hr /><hr /><hr /><hr /><hr /><hr />
